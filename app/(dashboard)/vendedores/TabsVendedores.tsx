...
const TABS = [
  { key: 'resumen',  label: 'Resumen',               href: '/vendedores' },
  { key: 'analisis', label: 'Análisis y Ranking',    href: '/vendedores?tab=analisis' },
]

export default function TabsVendedores({ activeTab }: { activeTab: string }) {
  return (
